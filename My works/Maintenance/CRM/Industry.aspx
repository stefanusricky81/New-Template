<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Responsive.master" AutoEventWireup="true" CodeFile="Industry.aspx.cs" Inherits="Maintenance_CRM_Industry" %>
        ...
        <asp:Panel ID="pnlContainer" runat="server" DefaultButton="btnSubmit">
            ...
            <div class="block">
                <div class="block-title">
                    <h2 style="display: none;"><strong>Industries</strong></h2>
                ...
                <div class="form-horizontal form-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox runat="server" ID="txtIndustry" MaxLength="50" CssClass="form-control" />
                        </div>
                    </div>
                            ...
                            <MasterTableView ShowHeadersWhenNoRecords="true" TableLayout="Fixed" DataKeyNames="Id" Width="100%" CommandItemDisplay="Top">
                                ...
                                <CommandItemTemplate>
                                    <div style="margin: 2px 5px; display: inline; float: left">
                                        <asp:HyperLink ID="hlAddNewRecord" runat="server" NavigateUrl="~/Maintenance/CRM/IndustryDetail.aspx?ID=0"><i class="gi gi-plus" title="Add New Industry"></i>  Add New Industry</asp:HyperLink>
                                    </div>
                                </CommandItemTemplate>
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn DataField="Id" ItemStyle-HorizontalAlign="Left"
                                        ...
                                        <ItemTemplate>
                                            <asp:HyperLink ID="btnEdit" runat="server" NavigateUrl='<%# Eval("Id","/Maintenance/CRM/IndustryDetail.aspx?Id={0}") %>'><i class="gi gi-pencil" title="Edit"></i></asp:HyperLink>
                                    ...
                                    <telerik:GridBoundColumn DataField="Industry" DataType="System.String" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="50%" HeaderText="Industry" SortExpression="Industry" UniqueName="Industry" />
