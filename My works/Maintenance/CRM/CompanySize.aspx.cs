...
public partial class Maintenance_CRM_CompanySize : System.Web.UI.Page
{
    ...
    {               
        ...
        rgGrid.DataSource = CRM.Maintenance.GetCompanySize(txtCompanySize.Text.Trim());
    }
    ...
    protected void rgGrid_OnRowCommand(object source, GridCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "Delete")
            {
                ...
                DesktopShared.EntityClasses.CrmcompanySizeEntity obj = new DesktopShared.EntityClasses.CrmcompanySizeEntity(_Id);
                obj.Delete();
                obj.Save();
