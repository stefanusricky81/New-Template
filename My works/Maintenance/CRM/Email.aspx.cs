...
public partial class Maintenance_CRM_Email : System.Web.UI.Page
{
    ...
    {                       
        rgGrid.DataSource = CRM.Maintenance.GetEmails(txtEmailName.Text.Trim());
    }
    ...
    protected void rgGrid_OnRowCommand(object source, GridCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "Delete")
            {
                ...
                DesktopShared.EntityClasses.CrmemailEntity obj = new DesktopShared.EntityClasses.CrmemailEntity(_Id);
                obj.Delete();
                obj.Save();
