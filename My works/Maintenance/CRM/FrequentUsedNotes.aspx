<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Responsive.master" AutoEventWireup="true" CodeFile="FrequentUsedNotes.aspx.cs" Inherits="Maintenance_CRM_FrequentUsedNotes" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="Server">
    <div class="content-header">
        <div class="header-section">
            <h1>Frequent Used Notes Search</h1>
        </div>
    </div>
        ...
        <asp:Panel ID="pnlContainer" runat="server" DefaultButton="btnSubmit">
            ...
            <div class="block">
                <div class="block-title">
                    <h2 style="display: none;"><strong>Frequent Used Notes</strong></h2>
                ...
                <div class="form-horizontal form-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox runat="server" ID="txtFrequentNotes" MaxLength="50" CssClass="form-control" />
                        </div>
                    </div>
                            ...
                            <MasterTableView ShowHeadersWhenNoRecords="true" TableLayout="Fixed" DataKeyNames="Id" Width="100%" CommandItemDisplay="Top">
                                ...
                                <CommandItemTemplate>
                                    <div style="margin: 2px 5px; display: inline; float: left">
                                        <asp:HyperLink ID="hlAddNewRecord" runat="server" NavigateUrl="~/Maintenance/CRM/FrequentUsedNotesDetail.aspx?ID=0"><i class="gi gi-plus" title="Add New Note"></i>  Add New Note</asp:HyperLink>
                                    </div>
                                </CommandItemTemplate>
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn DataField="Id" ItemStyle-HorizontalAlign="Left"
                                        ...
                                        <ItemTemplate>
                                            <asp:HyperLink ID="btnEdit" runat="server" NavigateUrl='<%# Eval("Id","/Maintenance/CRM/FrequentUsedNotesDetail.aspx?Id={0}") %>'><i class="gi gi-pencil" title="Edit"></i></asp:HyperLink>
                                    ...
                                    <telerik:GridBoundColumn DataField="Notes" DataType="System.String" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="50%" HeaderText="Notes" SortExpression="Notes" UniqueName="Notes" />
