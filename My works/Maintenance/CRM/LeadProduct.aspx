<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Responsive.master" AutoEventWireup="true" CodeFile="LeadProduct.aspx.cs" Inherits="Maintenance_CRM_LeadProduct" %>
        ...
        <asp:Panel ID="pnlContainer" runat="server" DefaultButton="btnSubmit">
            ...
            <div class="block">
                <div class="block-title">
                    <h2 style="display: none;"><strong>Lead Products</strong></h2>
                ...
                <div class="form-horizontal form-bordered">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Lead Product</label>
                        <div class="col-md-4">
                            <asp:TextBox runat="server" ID="txtLeadProduct" MaxLength="50" CssClass="form-control" />
                        </div>
                    </div>
                            ...
                            <MasterTableView ShowHeadersWhenNoRecords="true" TableLayout="Fixed" DataKeyNames="Id" Width="100%" CommandItemDisplay="Top">
                                ...
                                <CommandItemTemplate>
                                    <div style="margin: 2px 5px; display: inline; float: left">
                                        <asp:HyperLink ID="hlAddNewRecord" runat="server" NavigateUrl="~/Maintenance/CRM/LeadProductDetail.aspx?ID=0"><i class="gi gi-plus" title="Add New Lead Product"></i>  Add New Lead Product</asp:HyperLink>
                                    </div>
                                </CommandItemTemplate>
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn DataField="Id" ItemStyle-HorizontalAlign="Left"
                                        ...
                                        <ItemTemplate>
                                            <asp:HyperLink ID="btnEdit" runat="server" NavigateUrl='<%# Eval("Id","/Maintenance/CRM/LeadProductDetail.aspx?Id={0}") %>'><i class="gi gi-pencil" title="Edit"></i></asp:HyperLink>
