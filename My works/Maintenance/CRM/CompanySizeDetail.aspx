<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Responsive.master" AutoEventWireup="true" CodeFile="CompanySizeDetail.aspx.cs" Inherits="Maintenance_CRM_CompanySizeDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="Server">
    <div class="content-header">
        <div class="header-section">
            <h1>Company Size<asp:Literal ID="litHeaderName" runat="server" /></h1>
        </div>
    </div>
    <asp:PlaceHolder ID="phBreadcrumbs" runat="server">
        <div class="breadcrumb breadcrumb-top">
            <asp:HyperLink ID="hlBack" runat="server" Text="Back To Company Sizes" NavigateUrl="/Maintenance/CRM/CompanySize.aspx" />
                ...
                <div class="col-md-12">
                    <div class="block">
                        <div class="form-horizontal form-bordered">
                            ...
                            <div class="row">
                                <div class="col">
                                    <label class="col-sm-2 control-label">Company Size:<span class="text-danger">*</span></label>
                                </div>
                                <div class="form-group col-sm-3">
                                    <asp:TextBox ID="txtCompanySize" runat="server" MaxLength="50" Width="230" CssClass="form-control" />
                                    <asp:RequiredFieldValidator ID="rfvCompanySize" runat="server" ControlToValidate="txtCompanySize" ErrorMessage="Company Size is required." Display="None" ValidationGroup="vgEdit"></asp:RequiredFieldValidator>
                                    <asp:CustomValidator ID="cvCompanySize" runat="server" ControlToValidate="txtCompanySize" OnServerValidate="cvCompanySize_ServerValidate" ErrorMessage="Company Size already exists."
