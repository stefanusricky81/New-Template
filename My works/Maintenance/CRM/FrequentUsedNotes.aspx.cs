...
public partial class Maintenance_CRM_FrequentUsedNotes : System.Web.UI.Page
{
    ...
    {               
        ...
        rgGrid.DataSource = CRM.Maintenance.GetFrequentNotes(true, txtFrequentNotes.Text.Trim());
    }
    ...
    protected void rgGrid_OnRowCommand(object source, GridCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "Delete")
            {
                ...
                DesktopShared.EntityClasses.CrmfrequentUsedNoteEntity obj = new DesktopShared.EntityClasses.CrmfrequentUsedNoteEntity(_Id);
                obj.Delete();
                obj.Save();
