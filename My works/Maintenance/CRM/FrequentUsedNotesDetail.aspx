<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Responsive.master" AutoEventWireup="true" CodeFile="FrequentUsedNotesDetail.aspx.cs" Inherits="Maintenance_CRM_FrequentUsedNotesDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="Server">
    <div class="content-header">
        <div class="header-section">
            <h1>Frequent Used Notes<asp:Literal ID="litHeaderName" runat="server" /></h1>
        </div>
    </div>
    <asp:PlaceHolder ID="phBreadcrumbs" runat="server">
        <div class="breadcrumb breadcrumb-top">
            <asp:HyperLink ID="hlBack" runat="server" Text="Back To Frequent Used Notes" NavigateUrl="/Maintenance/CRM/FrequentUsedNotes.aspx" />
                ...
                <div class="col-md-12">
                    <div class="block">
                        <div class="form-horizontal form-bordered">
                            ...
                            <div class="row">
                                <div class="col">
                                    <label class="col-sm-2 control-label">Notes:<span class="text-danger">*</span></label>
                                </div>
                                <div class="form-group col-sm-3">
                                    <asp:TextBox ID="txtFrequentUsedNotes" runat="server" TextMode="MultiLine" Rows="10"  CssClass="form-control" />
                                    <asp:RequiredFieldValidator ID="rfvFrequentUsedNotes" runat="server" ControlToValidate="txtFrequentUsedNotes" ErrorMessage="Notes is required." Display="None" ValidationGroup="vgEdit"></asp:RequiredFieldValidator>
                                    <%--<asp:CustomValidator ID="cvFrequentUsedNotes" runat="server" ControlToValidate="txtFrequentUsedNotes" OnServerValidate="cvIndustry_ServerValidate" ErrorMessage="Notes already exists."
