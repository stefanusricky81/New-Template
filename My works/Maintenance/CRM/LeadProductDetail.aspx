<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Responsive.master" AutoEventWireup="true" CodeFile="LeadProductDetail.aspx.cs" Inherits="Maintenance_CRM_LeadProductDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="Server">
    <div class="content-header">
        <div class="header-section">
            <h1>Lead Product<asp:Literal ID="litHeaderName" runat="server" /></h1>
        </div>
    </div>
    <asp:PlaceHolder ID="phBreadcrumbs" runat="server">
        <div class="breadcrumb breadcrumb-top">
            <asp:HyperLink ID="hlBack" runat="server" Text="Back To Lead Products" NavigateUrl="/Maintenance/CRM/LeadProduct.aspx" />
                        ...
                        <div class="form-horizontal form-bordered">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-3">
                                    <asp:TextBox ID="txtLeadProduct" runat="server" MaxLength="50" Width="230" CssClass="form-control" />
                                    <asp:RequiredFieldValidator ID="rfvLeadProduct" runat="server" ControlToValidate="txtLeadProduct" ErrorMessage="Lead Product Name is required." Display="None" ValidationGroup="vgEdit"></asp:RequiredFieldValidator>
                                    <asp:CustomValidator ID="cvLeadProduct" runat="server" ControlToValidate="txtLeadProduct" OnServerValidate="cvLeadProduct_ServerValidate" ErrorMessage="Lead Product already exists."
