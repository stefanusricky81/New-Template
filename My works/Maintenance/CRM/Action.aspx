<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Responsive.master" AutoEventWireup="true" CodeFile="Action.aspx.cs" Inherits="Maintenance_CRM_Action" %>
            ...
            <div class="block">
                ...
                <div class="form-horizontal form-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox runat="server" ID="txtAction" MaxLength="50" CssClass="form-control" />
                        </div>
                    </div>
                            ...
                            <MasterTableView ShowHeadersWhenNoRecords="true" TableLayout="Fixed" DataKeyNames="Id" Width="100%" CommandItemDisplay="Top">
                                ...
                                <CommandItemTemplate>
                                    <div style="margin: 2px 5px; display: inline; float: left">
                                        <asp:HyperLink ID="hlAddNewRecord" runat="server" NavigateUrl="~/Maintenance/CRM/ActionDetail.aspx?ID=0"><i class="gi gi-plus" title="Add New Action"></i>  Add New Action</asp:HyperLink>
                                    </div>
                                </CommandItemTemplate>
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn DataField="Id" ItemStyle-HorizontalAlign="Left"
                                        ...
                                        <ItemTemplate>
                                            <asp:HyperLink ID="btnEdit" runat="server" NavigateUrl='<%# Eval("Id","/Maintenance/CRM/ActionDetail.aspx?Id={0}") %>'><i class="gi gi-pencil" title="Edit"></i></asp:HyperLink>
                                    ...
                                    <telerik:GridBoundColumn DataField="Action" DataType="System.String" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="50%" HeaderText="Action" SortExpression="Action" UniqueName="Action" />
