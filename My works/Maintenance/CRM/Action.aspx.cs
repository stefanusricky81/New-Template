...
public partial class Maintenance_CRM_Action : System.Web.UI.Page
{
    ...
    {               
        ...
        rgGrid.DataSource = CRM.Maintenance.GetActions(true, txtAction.Text.Trim());
    }
    ...
    protected void rgGrid_OnRowCommand(object source, GridCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "Delete")
            {
                ...
                DesktopShared.EntityClasses.CrmactionEntity obj = new DesktopShared.EntityClasses.CrmactionEntity(_Id);
                obj.Delete();
                obj.Save();
