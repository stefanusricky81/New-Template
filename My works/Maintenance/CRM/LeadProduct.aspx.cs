...
public partial class Maintenance_CRM_LeadProduct : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {           
            ...
            //bool IncludeInactive = (ddlIncludeInactive.SelectedValue) == "Y" ? true : false;
            //CRM.Lead.SaveSearchSettings(ddlImportList.ImportListId, ddlLeadProduct.LeadProductId, ddlNextAction.ActionId, txtCompany.Text.Trim(), txtLastName.Text.Trim(), dtStartFollowupDate.SelectedDate, dtEndFollowupDate.SelectedDate, ddlInterestLevel.InterestLevelId, IncludeInactive);
            RebindGrid();
        }
    }
    ...
    {        
        string ProductName = txtLeadProduct.Text.Trim();
        //bool IncludeInactive = (chkActive.Checked) ? true : false;        
        rgGrid.DataSource = CRM.Maintenance.GetLeadProducts(true, txtLeadProduct.Text.Trim());
    }
    ...
    protected void rgGrid_OnRowCommand(object source, GridCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "Delete")
            {
                ...
                DesktopShared.EntityClasses.CrmleadProductEntity obj = new DesktopShared.EntityClasses.CrmleadProductEntity(_Id);
                obj.Delete();
                obj.Save();
