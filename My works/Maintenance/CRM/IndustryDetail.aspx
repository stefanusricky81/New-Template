<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Responsive.master" AutoEventWireup="true" CodeFile="IndustryDetail.aspx.cs" Inherits="Maintenance_CRM_IndustryDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="Server">
    <div class="content-header">
        <div class="header-section">
            <h1>Industry<asp:Literal ID="litHeaderName" runat="server" /></h1>
        </div>
    </div>
    <asp:PlaceHolder ID="phBreadcrumbs" runat="server">
        <div class="breadcrumb breadcrumb-top">
            <asp:HyperLink ID="hlBack" runat="server" Text="Back To Industries" NavigateUrl="/Maintenance/CRM/Industry.aspx" />
                ...
                <div class="col-md-12">
                    <div class="block">
                        <div class="form-horizontal form-bordered">
                            ...
                            <div class="row">
                                <div class="col">
                                    <label class="col-sm-2 control-label">Industry:<span class="text-danger">*</span></label>
                                </div>
                                <div class="form-group col-sm-3">
                                    <asp:TextBox ID="txtIndustry" runat="server" MaxLength="50" Width="230" CssClass="form-control" />
                                    <asp:RequiredFieldValidator ID="rfvIndustry" runat="server" ControlToValidate="txtIndustry" ErrorMessage="Industry is required." Display="None" ValidationGroup="vgEdit"></asp:RequiredFieldValidator>
                                    <asp:CustomValidator ID="cvIndustry" runat="server" ControlToValidate="txtIndustry" OnServerValidate="cvIndustry_ServerValidate" ErrorMessage="Industry already exists."
