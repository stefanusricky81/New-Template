<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Responsive.master" AutoEventWireup="true" CodeFile="BillingSKU.aspx.cs" Inherits="Maintenance_BillingSKU" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" Runat="Server">
    ...
    <asp:Panel ID="pnlContainer" runat="server" DefaultButton="btnSubmit">
        <div class="block">
            <div class="row">
                ...
                <div class="form-group col-sm-4">
                    <asp:TextBox ID="txtSeachSKU" runat="server" MaxLength="25" CssClass="form-control" PlaceHolder="Enter SKU" />
                </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-4">
                    <asp:TextBox ID="txtSeachDesc" runat="server" MaxLength="25" CssClass="form-control" PlaceHolder="Enter Description" />
                </div>
                <div class="form-group col-sm-1">
                    <label>SKU Category</label>
                </div>
                <div class="form-group col-sm-5">
                    <asp:DropDownList ID="ddlSearchSKUCategory" runat="server" CssClass="form-control select-chosen" />
                </div>
            </div>
            <div class="row">
                <div class="form-group col-sm-6">
                    <asp:LinkButton ID="btnSubmit" runat="server" CssClass="btn btn-sm btn-primary" OnClick="btnSubmit_Click" ValidationGroup="vgBillingSKU"><i class="hi hi-search"></i> Search</asp:LinkButton>
        ...
        <div class="block">
            ...
            <div class="row">
                <telerik:RadGrid ID="rgBillingSKU" runat="server" Skin="3b" EnableEmbeddedSkins="false" AutoGenerateColumns="false" AllowSorting="true" 
                    AllowPaging="true" ShowFooter="false" PageSize="10" Width="100%" OnNeedDataSource="rgBillingSKU_NeedDataSource"
                    OnItemCommand="rgBillingSKU_ItemCommand">
                    <MasterTableView ShowHeadersWhenNoRecords="true" TableLayout="Fixed" DataKeyNames="Id" Width="100%" AllowSorting="true">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="SKU" HeaderStyle-Width="30%" DataType="System.String" ItemStyle-HorizontalAlign="Left" HeaderText="SKU" SortExpression="SKU" UniqueName="SKU" />
                            <telerik:GridBoundColumn DataField="CategoryName" HeaderStyle-Width="30%" DataType="System.String" ItemStyle-HorizontalAlign="Left" HeaderText="CategoryName" SortExpression="CategoryName" UniqueName="CategoryName" />
                            ...
                            <telerik:GridBoundColumn DataField="fk_SKUcategoryid" Display="false" DataType="System.String" HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderText="CatId" SortExpression="fk_SKUcategoryid" UniqueName="fk_SKUcategoryid" />
                        </Columns>
                    </MasterTableView>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="row">
                                    <label class="col-md-4 control-label">SKU<asp:RequiredFieldValidator ID="rfvSKU" runat="server" ControlToValidate="txtSKU" ForeColor="Red" ErrorMessage="SKU is required" ValidationGroup="vgAddEdit">*</asp:RequiredFieldValidator></label>
                                    <div class="col-md-8">
                                        <asp:TextBox runat="server" ID="txtSKU" MaxLength="30" CssClass="form-control" Placeholder="Enter SKU" />
                                        <asp:HiddenField ID="hfOldSKU" runat="server" />
                                    </div>
                                </div>
                                <div class="row">
                                    <label class="col-md-4 control-label">SKU Category</label>
                                    <div class="col-md-8">
                                        <asp:DropDownList ID="ddlAddSKUCategory" runat="server" CssClass="form-control select-chosen" />
                                    </div>
                                </div>
