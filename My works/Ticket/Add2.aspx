<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Responsive.master" AutoEventWireup="true" CodeFile="Add2.aspx.cs" Inherits="Ticket_Add2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" Runat="Server">
    ...
    <script>
        ...
        function conditionalPostback(e, sender) {
            var theRegexp = new RegExp("\.btnSubmit$|\.btnSubmit2$", "ig");
...
<%--<telerik:RadAjaxPanel ID="rapTicket" runat="server" LoadingPanelID="ralpTicket" EnableAJAX="true" ClientEvents-OnRequestStart="conditionalPostback">--%>
     <div class="breadcrumb breadcrumb-top">
        <a href="Add.aspx">Add Ticket Legacy</a> | 
        <a href="Search.aspx">Ticket Search</a> |  
        <a href="List.aspx">My Views</a>
    </div>
    <asp:Literal ID="litMessage" runat="server" />
    <asp:Panel ID="pnlSummaryAdd" Visible="false" runat="server">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="block-content">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <ddl:SmartClient ID="ddlSmartClient" runat="server" />
                                    <%--<uc:SmartClientResposive ID="scrClient" runat="server" Autopostback="true" />--%>
                                    
                                </div>
                                <label class="col-sm-3 control-label">Internal Only</label>
                                <div class="col-sm-3">
                                    <asp:CheckBox ID="chkInternal" runat="server" CssClass="form-control form-control-borderless" AutoPostBack="true" OnCheckedChanged="chkInternal_CheckedChanged" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Contact <span class="text-danger">*</span></label>
                                <div class="col-sm-3">
                                    <ddl:ClientContact ID="ddlClientContact" runat="server" IsRequired="true" DisplayDefaultValue="true" DefaultText="" DefaultValue="" Visible="true" UseClientContactIdAsDataValue="true" ValidationGroup="vgTicket" />
                                </div>
                                <div class="col-sm-1">
                                    <asp:Literal ID="ltVIP" runat="server" />
                                </div>
                                 <label class="col-sm-3 control-label">Action</label>
                                <div class="col-sm-3">
                                    <asp:PlaceHolder ID="phEditContact" runat="server" Visible="false"><a href="#modal-edit-contact" data-toggle="modal" class="btn btn-sm btn-primary">Update Contact</a></asp:PlaceHolder>
                                    <asp:PlaceHolder ID="phAddContact" runat="server" Visible="false"><a href="#modal-add-contact" data-toggle="modal" class="btn btn-sm btn-primary">Add New Contact</a></asp:PlaceHolder>
                                </div>
                            </div>
                            <div class="form-group">
                                 <label class="col-sm-2 control-label">Status <span class="text-danger">*</span></label>
                                <div class="col-sm-4">
                                    <ddl:TicketDisposition ID="ddlTicketDisposition" runat="server" IsRequired="true" ValidationGroup="vgTicket" DisplayChosenScript="true"  />
                                </div>
                                <label class="col-sm-3 control-label">Sales</label>
                                <div class="col-sm-3 form-control-static"><asp:Literal ID="litSales" runat="server" /></div>
                            </div>
                            <div class="form-group">
                                 <label class="col-sm-2 control-label">Ticket Type <span class="text-danger">*</span></label>
                                <div class="col-sm-4">
                                    <ddl:TicketType ID="ddlTicketType" runat="server" IsRequired="true" ValidationGroup="vgTicket" DisplayChosenScript="true" />
                                </div>
                                <label class="col-sm-3 control-label">Lead Tech</label>
                                <div class="col-sm-3 form-control-static"><asp:Label ID="lblLeadTech" runat="server" /></div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Assigned To <span class="text-danger">*</span></label>
                                <div class="col-sm-4">
                                ...
                                <label class="col-sm-3 control-label">Tam</label>
                                <div class="col-sm-3 form-control-static"><asp:Label ID="lblTam" runat="server" /></div>
                            </div>
                            <div class="form-group">
                                 <div class="col-sm-6"></div>
                                <label class="col-sm-3 control-label">CSM</label>
                                <div class="col-sm-3 form-control-static"><asp:Label ID="lblCSM" runat="server" /></div>
                            </div>
                             <asp:PlaceHolder ID="phLocation" runat="server" Visible="false">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <ddl:ClientLocation ID="ddlClientLocation" runat="server" IsRequired="true" DisplayChosenScript="true" ValidationGroup="vgTicket" DefaultText="" DefaultValue="" DisplayDefaultValue="true"/>
                                    </div>
                                </div>
                            </asp:PlaceHolder>
                        </div>
                         ...
                         <div class="row">
                            <div class="col-sm-7 col-xs-12">
                                <div class="input-group">
                                    <lb:ClientContact ID="lbClientContact" runat="server" DisplayChosenScript="true" UseEmailAsDataValue="true" ValidationGroup="vgAddRecipientClient" 
...
<%--                                    <ddl:ClientContact ID="ddlClientContactRecipient" runat="server" IsRequired="true" ValidationGroup="vgAddRecipientClient" DisplayChosenScript="true" DefaultValue="" UseEmailAsDataValue="true"
                                        RequiredErrorMessage="Client Contact is required" Visible="false" />--%>
                             ...
                             <asp:PlaceHolder ID="phAddContactButton" runat="server" Visible="false">
                        ...
                        <div class="row">
                            <div class="col-sm-7 col-xs-12">
                                <div class="input-group">
                                    ...
                                    <lb:Employee ID="lbEmployeeRecipient" runat="server" UseEmailAsDataValue="true" 
                                        RequiredErrorMessage="Bit By Bit Employee is required" DisplayChosenScript="true" DisplayErrorAsterisk="false" SetSize="false" HideQueueEmployees="true" />
                                    <span class="input-group-btn">
                    ...
                    <div class="block-content">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                ...
                                <asp:TextBox ID="txtSummary" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="2" PlaceHolder="Ticket Summary"/>
                                <asp:RequiredFieldValidator ControlToValidate="txtSummary" runat="server" ID="rfvSummary" ValidationGroup="vgTicket" Display="None" ErrorMessage="Summary is required" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <label>Description <span class="text-danger">*</span></label>
                                <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="4" PlaceHolder="Ticket Description"/>
                                <asp:RequiredFieldValidator ControlToValidate="txtDescription" runat="server" ID="rfvDescription" ValidationGroup="vgTicket" Display="None" ErrorMessage="Description is required" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <asp:CustomValidator ID="cvTimesheet" runat="server" ControlToValidate="txtInternalNotes" ValidateEmptyText="true" ValidationGroup="vgTicket" OnServerValidate="cvTimesheet_ServerValidate" 
                        ...
                        <div class="row">
                         ...
                         <div class="form-group form-actions" style="margin-top:10px; margin-bottom:40px;">
                            <asp:LinkButton ID="btnSubmit" runat="server" ValidationGroup="vgTicket" OnClick="btnSubmit_Click" CausesValidation="true" CssClass="btn btn-sm btn-info pull-right"><i class="hi hi-ok"></i> Add Ticket</asp:LinkButton>
                        </div>
                    </div>
                </div>
                <div class="block" style="padding-bottom:10px;">
                    ...
                    <div class="block-content">
                        <div class="row">
                            ...
                            <asp:CustomValidator ID="cvScheduled" runat="server" ControlToValidate="txtDescription" ValidateEmptyText="true" ValidationGroup="vgTicket" OnServerValidate="cvScheduled_ServerValidate" Display="None" />
                        </div>
                    </div>
                </div>
                            ...
                            <div class="form-group col-sm-12">
                                <div class="row">                                
                                    ...
                                    <div class="form-group col-sm-2" style="padding-left:0;">
                                        <a class="btn btn-sm btn-primary" href="#modal-add-tag" data-toggle="modal"><i class="hi hi-plus"></i> Create Tag</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="block-content">
                        <div class="row">     
                            <div class="form-group col-sm-12">
                                ...
                                <asp:CustomValidator ID="cvFile" runat="server" ControlToValidate="txtValidator" ValidationGroup="vgTicket" Display="None"
        ...
        <div class="block" style="padding-bottom:20px;">
            <div class="form-actions">
                <asp:LinkButton ID="btnSubmit2" runat="server" ValidationGroup="vgTicket" OnClick="btnSubmit_Click" CausesValidation="true" CssClass="btn btn-sm btn-info"><i class="hi hi-ok"></i> Add Ticket</asp:LinkButton>
            </div>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title"><asp:Literal ID="litEditContactHeader" runat="server" Text="Update Contact" /></h3>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-horizontal form-bordered">
                            ...
                            <div class="modal-footer">
                                <asp:LinkButton ID="btnAddTag" runat="server" ValidationGroup="vgAddTag" OnClick="btnAddTag_Click" CausesValidation="true" CssClass="btn btn-sm btn-primary"><i class="hi hi-ok" title="Create Tag"></i> Create Tag</asp:LinkButton>
                                <button type="button" class="btn btn-sm btn-primary" data-dismiss="modal">Close</button>
                            </div>
                        </div>
                    </div>
