<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Responsive.master" AutoEventWireup="true" CodeFile="ClientTicketReport.aspx.cs" Inherits="Reports_ClientTicketReport" %>
            ...
            <div class="table-responsive scroll">
                ...
                <MasterTableView ShowHeadersWhenNoRecords="true" DataKeyNames="ID" TableLayout="Fixed" Width="150%">
                    ...
                    <Columns>
                        ...
                        <%--<telerik:GridBoundColumn DataField="UPDATENOTES" HeaderStyle-Width="7%" DataType="System.String" ItemStyle-HorizontalAlign="Left" HeaderText="Update Notes" SortExpression="UPDATENOTES" UniqueName="UPDATENOTES" HeaderTooltip="Update Notes" />--%>
