...
public partial class Reports_TicketTimeDetail : System.Web.UI.Page
{
    int _critical;
    int _high;
    int _normal;
    ...
    protected void lbexport_Click(object sender, EventArgs e)
    {
        ...
        rgClientTicketReport.ExportSettings.FileName = "Ticket Time Detail :" + ucCreatedStart.SelectedDate.Value.ToString("MM/dd/yyyy") + "-" + ucCreatedEnd.SelectedDate.Value.ToString("MM/dd/yyyy") + "_" + DateTime.Now.ToString("yyyyMMdd-hhmmss");
    ...
    protected void rgReceiveVia_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        switch (command)
        {
            ...
            case "CriticalReceivedVia":
                ...
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "RV", ddlClient.ClientId, "C", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            case "HighReceivedVia":
                GridDataItem itemhrv = (GridDataItem)e.Item;
                DataKey = itemhrv["Detail"].Text;
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "RV", ddlClient.ClientId, "H", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            case "NormalReceivedVia":
                GridDataItem itemnrv = (GridDataItem)e.Item;
                DataKey = itemnrv["Detail"].Text;
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "RV", ddlClient.ClientId, "N", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            case "LowReceivedVia":
                GridDataItem itemlrv = (GridDataItem)e.Item;
                DataKey = itemlrv["Detail"].Text;
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "RV", ddlClient.ClientId, "L", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            #endregion
            ...
            case "CriticalTicketCategory":
                ...
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "TG", ddlClient.ClientId, "C", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            case "HighTicketCategory":
                GridDataItem itemhtg = (GridDataItem)e.Item;
                DataKey = itemhtg["Detail"].Text;
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "TG", ddlClient.ClientId, "H", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            case "NormalTicketCategory":
                GridDataItem itemntg = (GridDataItem)e.Item;
                DataKey = itemntg["Detail"].Text;
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "TG", ddlClient.ClientId, "N", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            case "LowTicketCategory":
                GridDataItem itemltg = (GridDataItem)e.Item;
                DataKey = itemltg["Detail"].Text;
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "TG", ddlClient.ClientId, "L", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            #endregion
            ...
            case "CriticalTicketStatus":
                ...
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "TS", ddlClient.ClientId, "C", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            case "HighTicketStatus":
                GridDataItem itemhts = (GridDataItem)e.Item;
                DataKey = itemhts["TICKETSTATUS"].Text == "Open" ? _open : closed;
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "TS", ddlClient.ClientId, "H", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            case "NormalTicketStatus":
                GridDataItem itemnts = (GridDataItem)e.Item;
                DataKey = itemnts["TICKETSTATUS"].Text == "Open" ? _open : closed;
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "TS", ddlClient.ClientId, "N", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            case "LowTicketStatus":
                GridDataItem itemlts = (GridDataItem)e.Item;
                DataKey = itemlts["TICKETSTATUS"].Text == "Open" ? _open : closed;
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "TS", ddlClient.ClientId, "L", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            #endregion
            ...
            case "CriticalResponseTime":
                ...
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", _type, ddlClient.ClientId, "C", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            case "HighResponseTime":
                ...
                DataKey = lbHigh.Text;
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", _type, ddlClient.ClientId, "H", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            case "NormalResponseTime":
                ...
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", _type, ddlClient.ClientId, "N", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            case "LowResponseTime":
                ...
                DataKey = lbLow.Text;
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", _type, ddlClient.ClientId, "L", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, DataKey));
                break;
            #endregion

            #region VIP
            case "CriticalVIP":
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "VIP", ddlClient.ClientId, "C", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, "VIP"));
                break;
            case "HighVIP":
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "VIP", ddlClient.ClientId, "H", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, "VIP"));
                break;
            case "NormalVIP":
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "VIP", ddlClient.ClientId, "N", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, "VIP"));
                break;
            case "LowVIP":
                Response.Redirect(string.Format("~/Reports/TicketTimeDetails.aspx?type={0}&clientid={1}&priority={2}&start={3}&end={4}&detail={5}", "VIP", ddlClient.ClientId, "L", ucCreatedStart.SelectedDate.Value, ucCreatedEnd.SelectedDate.Value, "VIP"));
                break;
                #endregion
        }
    }
