...
public partial class UserControl_Grid_Ticket : System.Web.UI.UserControl
{
    private DesktopShared.Ticket.GridType _type = DesktopShared.Ticket.GridType.Employee;

    private UserControl_Grid_Ticket _taggedTicketUserControl = null;
    private UserControl_Grid_Ticket _viewTicketUserControl = null;
    private UserControl_Grid_Ticket _helpDeskTicketUserControl = null;
    private UserControl_Grid_Ticket _backupTicketUserControl = null;
    private UserControl_Grid_Ticket _level2QueueTicketUserControl = null;
    private UserControl_Grid_Ticket _priorityUserTicketUserControl = null;
    private UserControl_Grid_Ticket _employeeTicketUserControl = null;
    private UserControl_Grid_Ticket _recentTicketUserControl = null;
    private UserControl_Grid_Ticket _priorityClientTicketUserControl = null;
    private UserControl_Grid_Ticket _helpDeskClientTicketUserControl = null;
    private UserControl_Grid_Ticket _scheduledTicketUserControl = null;
    private UserControl_Grid_Ticket _designationAlertTicketUserControl = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //set event handler for records per page
        ...
        //set event handler for recurring ticket
        DropDownList ddlTicketRecurring = ucTicketRecurring.GetDropDownList();
        ddlTicketRecurring.AutoPostBack = true;
        ddlTicketRecurring.SelectedIndexChanged += new EventHandler(ddlTicketRecurring_SelectedIndexChanged);
    ...
    /// <summary>
    /// ticket grid on need data source
    /// </summary>
    ...
    /// <summary>
    /// ticket grid on item data bound
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    protected void rgTicket_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
    {
        ...
        if (e.Item.ItemType == GridItemType.Item || e.Item.ItemType == GridItemType.AlternatingItem)
        {
            ...
            #region priority client and/or helpdesk client [removed]
    ...
    /// <summary>
    /// ticket grid on item created
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    protected void rgTicket_ItemCreated(object sender, Telerik.Web.UI.GridItemEventArgs e)
    {
        #region Item or AlternatingItem
        ...
        if (e.Item.ItemType == GridItemType.Item || e.Item.ItemType == GridItemType.AlternatingItem)
        {
            ...
            {
                TableCell tcEditCommandColumn = item["EditCommandColumn"];
                //tcEditCommandColumn.Controls.Add(new LiteralControl("&nbsp;|&nbsp;"));
                tcEditCommandColumn.Controls.Clear();

                LinkButton lbMakeActive = new LinkButton();
                lbMakeActive.ID = "lbMakeActive";
    ...
    /// <summary>
    /// ticket grid on update command
    /// </summary>
    /// <param name="source"></param>
    /// <param name="e"></param>
    protected void rgTicket_UpdateCommand(object source, GridCommandEventArgs e)
    {
        if (Page.IsValid)
        {
    ...
    /// <summary>
    /// ticket grid on insert command
    /// </summary>
    /// <param name="source"></param>
    /// <param name="e"></param>
    protected void rgTicket_InsertCommand(object source, GridCommandEventArgs e)
    {
        if (Page.IsValid)
        {
            GridEditableItem editedItem = e.Item as GridEditableItem;
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    protected void rgTicket_SortCommand(object sender, Telerik.Web.UI.GridSortCommandEventArgs e)
    {
    ...
    /// <summary>
    /// ticket grid on item command
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    protected void rgTicket_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
    {
        bool doRebind = false;
        ...
        else if (e.CommandName == "CloseSelected")
        {
            ...
            foreach (GridDataItem _itemToClose in rgTicket.SelectedItems)
            {
        ...
        else if (e.CommandName == "MakeActive")
        {
            ...
            if (!_currentActiveTicketId.HasValue) //no current active ticket for employee = no old ticket to update
                Response.Redirect(String.Format("/Ticket/Detail2.aspx?Id={0}", cscDefectID));//redirect to ticket  
    ...
    /// <summary>
    /// record per page drop down list on selected change
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    protected void ddlRecordsPerPage_SelectedChange(object sender, EventArgs e)
    {
        DesktopShared.User.Ticket.RecordsPerPage = ucRecordsPerPage.SelectedValue;
        rgTicket.Rebind();
    }

    /// <summary>
    /// last updated drop down list on selected change
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    protected void ddlLastUpdated_SelectedChange(object sender, EventArgs e)
    {
        LastUpdatedWarning = Convert.ToInt32(ddlLastUpdated.SelectedValue);
        rgTicket.Rebind();
    }
    ...
    /// <summary>
    /// ticket recurring drop down list on selected index changed
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    protected void ddlTicketRecurring_SelectedIndexChanged(object sender, EventArgs e)
    {
        DesktopShared.User.Ticket.SetRecurring(_type.ToString().Trim(),ucTicketRecurring.IsRecurring);
        rgTicket.Rebind();
    }
    ...
    private void ConfigureExport()
    {
        ...
        //hide link columns
        rgTicket.MasterTableView.Columns.FindByUniqueName("EditCommandColumn").Visible = false;
    ...
    private void CreateColumns()
    {
        ...
        rgTicket.MasterTableView.Columns.Add(_gridEditCmdColumn);
        _gridEditCmdColumn.UniqueName = "EditCommandColumn";
        _gridEditCmdColumn.HeaderStyle.Width = Unit.Percentage(7);
        _gridEditCmdColumn.EditText = "Edit";

        //priority
        boundColumn = new GridBoundColumn();
        rgTicket.MasterTableView.Columns.Add(boundColumn);
        boundColumn.DataField = "PriorityName";
        boundColumn.UniqueName = "PriorityName";
        boundColumn.HeaderText = "P#";
        boundColumn.SortExpression = "PriorityName";
        boundColumn.HeaderStyle.Width = Unit.Percentage(3);
        ...
        boundColumn.HeaderText = "No.";
        boundColumn.SortExpression = "Id";
        boundColumn.HeaderStyle.Width = Unit.Percentage(6);
        
        //summary
        hyperLinkColumn = new GridHyperLinkColumn();
        rgTicket.MasterTableView.Columns.Add(hyperLinkColumn);
        hyperLinkColumn.UniqueName = "Summary";
        string[] navUrlFields = new string[1];
        navUrlFields[0] = "Id";
        if (_type == DesktopShared.Ticket.GridType.ClientHistory)
            hyperLinkColumn.Target = "_blank";
        hyperLinkColumn.DataNavigateUrlFields = navUrlFields;
        hyperLinkColumn.DataTextField = "Summary";
        hyperLinkColumn.DataNavigateUrlFormatString = "/Ticket/Detail2.aspx?Id={0}";
        hyperLinkColumn.SortExpression = "Summary";
        hyperLinkColumn.HeaderText = "Summary";
        hyperLinkColumn.HeaderStyle.Width = Unit.Percentage(20);
        ...
        boundColumn.SortExpression = "CompanyName";
        boundColumn.HeaderStyle.Width = Unit.Percentage(12);

        //disposition/status
        boundColumn = new GridBoundColumn();
        rgTicket.MasterTableView.Columns.Add(boundColumn);
        boundColumn.DataField = "DispositionName";
        boundColumn.UniqueName = "DispositionName";
        boundColumn.HeaderText = "Status";
        boundColumn.SortExpression = "DispositionDisplayorder";
        boundColumn.HeaderStyle.Width = Unit.Percentage(8);

        //ticket type
        boundColumn = new GridBoundColumn();
        rgTicket.MasterTableView.Columns.Add(boundColumn);
        boundColumn.DataField = "TicketTypeName";
        boundColumn.UniqueName = "TicketTypeName";
        boundColumn.HeaderText = "Type";
        boundColumn.SortExpression = "TicketTypeName";
        boundColumn.HeaderStyle.Width = Unit.Percentage(6);

        //date entered
        boundColumn = new GridBoundColumn();
        rgTicket.MasterTableView.Columns.Add(boundColumn);
        boundColumn.DataField = "DateEntered";
        boundColumn.UniqueName = "DateEntered";
        boundColumn.HeaderText = "Entered";
        boundColumn.SortExpression = "DateEntered";
        ...
        boundColumn = new GridBoundColumn();
        rgTicket.MasterTableView.Columns.Add(boundColumn);
        boundColumn.DataField = "ScheduledDate";
        boundColumn.UniqueName = "ScheduledDate";
        boundColumn.HeaderText = "Scheduled";
        boundColumn.SortExpression = "ScheduledDate";
        boundColumn.DataFormatString = "{0:MM/dd/yy HH:mm}";
        boundColumn.HeaderStyle.Width = Unit.Percentage(10);
        ...
        boundColumn = new GridBoundColumn();
        rgTicket.MasterTableView.Columns.Add(boundColumn);
        boundColumn.DataField = "NeedCompletionDate";
        boundColumn.UniqueName = "NeedCompletionDate";
        boundColumn.HeaderText = "Complete By";
        boundColumn.SortExpression = "NeedCompletionDate";
        boundColumn.DataFormatString = "{0:MM/dd/yy HH:mm}";
        boundColumn.HeaderStyle.Width = Unit.Percentage(10);
        ...
        boundColumn = new GridBoundColumn();
        rgTicket.MasterTableView.Columns.Add(boundColumn);
        boundColumn.UniqueName = "UserFirstName";
        boundColumn.DataField = "UserFirstName";
        boundColumn.HeaderText = "Assigned";
        boundColumn.SortExpression = "UserFirstName";
        boundColumn.HeaderStyle.Width = Unit.Percentage(IncludeTimeSpent ? 11 : 14);
        boundColumn.ColumnEditorID = "ucEmployee";
        ...
        if (IncludeTimeSpent)
        {
            boundColumn = new GridBoundColumn();
            rgTicket.MasterTableView.Columns.Add(boundColumn);
            boundColumn.UniqueName = "TotalTimeSpent";
            boundColumn.DataField = "TotalTimeSpent";
            boundColumn.HeaderStyle.Width = Unit.Percentage(3);
            boundColumn.SortExpression = "TotalTimeSpent";
            boundColumn.HeaderText = "TS";
            boundColumn.HeaderTooltip = "Time Spent";
        }

        //estimate column
        boundColumn = new GridBoundColumn();
        rgTicket.MasterTableView.Columns.Add(boundColumn);
        boundColumn.UniqueName = "HoursToFix";
        boundColumn.DataField = "HoursToFix";
        boundColumn.HeaderStyle.Width = Unit.Percentage(3);
        boundColumn.SortExpression = "HoursToFix";
        boundColumn.HeaderText = "Est.";
        boundColumn.HeaderTooltip = "Estimate";
        ...
        boundColumn.HeaderStyle.Width = Unit.Percentage(3);
        boundColumn.SortExpression = "TaggedTicketId";
        boundColumn.HeaderText= "Tag";

        //product (used for Batch edit)
        boundColumn = new GridBoundColumn();
        rgTicket.MasterTableView.Columns.Add(boundColumn);
        boundColumn.UniqueName = "Product";
        boundColumn.SortExpression = "ProductId";
    ...
    /// <summary>
    /// insert last updated drop down list items
    /// </summary>
    private void SetUpLastUpdatedLists()
    {
        #region hour values
        ...
        {   
            ...
            if (i == 0)
                ...
                li.Text = i.ToString() + " hour";
            else
                li.Text = i.ToString() + " hours";

            ddlLastUpdated.Items.Insert(i, li);
        }
        ...
        string itemText = "1/2 day";
        string itemValue = "12";
        ddlLastUpdated.Items.Add(new ListItem(itemText, itemValue));
        ...
        ddlLastUpdated.Items.FindByValue(LastUpdatedWarning.ToString()).Selected = true;
        
    }

    /// <summary>
    /// set records per page drop down list selected value
    /// </summary>
    private void SetUpRecordsPerPage()
    {
        ucRecordsPerPage.SelectedValue = DesktopShared.User.Ticket.RecordsPerPage;
    }

    /// <summary>
    /// set ticket recurring drop down list selected value
    /// </summary>
    private void SetUpTicketRecurring()
    {
        ucTicketRecurring.IsRecurring = DesktopShared.User.Ticket.GetRecurring(_type.ToString().Trim());
    }
    ...
    private void SetUpHeader()
    {
        ...
        SetUpLastUpdatedLists();
        SetUpRecordsPerPage();
        SetUpTicketRecurring();
        SetUpTableHeader();
    }
    ...
    /// <summary>
    /// get telerik grid based on grid type
    /// </summary>
    ...
    /// </summary>
    public UserControl_Grid_Ticket HelpDeskClientTicketUserControl
    {
    ...
    /// </summary>
    public UserControl_Grid_Ticket PriorityClientTicketUserControl
    {
    ...
    /// </summary>
    public UserControl_Grid_Ticket PriorityUserTicketUserControl
    {
    ...
    /// </summary>
    public UserControl_Grid_Ticket TaggedTicketUserControl
    {
    ...
    /// </summary>
    public UserControl_Grid_Ticket ViewTicketUserControl
    {
    ...
    /// </summary>
    public UserControl_Grid_Ticket HelpDeskTicketUserControl
    {
    ...
    /// </summary>
    public UserControl_Grid_Ticket BackupTicketUserControl
    {
    ...
    /// </summary>
    public UserControl_Grid_Ticket Level2QueueTicketUserControl
    {
    ...
    /// </summary>
    public UserControl_Grid_Ticket RecentTicketUserControl
    {
    ...
    /// </summary>
    public UserControl_Grid_Ticket ScheduledTicketUserControl
    {
    ...
    /// </summary>
    public UserControl_Grid_Ticket EmployeeTicketUserControl
    {
    ...
    /// </summary>
    public UserControl_Grid_Ticket DesignationAlertTicketUserControl
    {
