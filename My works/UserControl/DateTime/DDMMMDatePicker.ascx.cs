...
public partial class UserControl_DateTime_DatePicker : System.Web.UI.UserControl
{
    ...
    { // add this  line: $('th.picker-switch[data-action=pickerSwitch][title='Select Decade']').click(function(){ return false; });
        System.Text.StringBuilder sb = new System.Text.StringBuilder();
        sb.Append("<script type='text/javascript'>");
        sb.Append("$(document).ready(function() {");
        //sb.Append("$(document).ready(function() { $('th.picker-switch[data-action=pickerSwitch][title='Select Decade']').click(function(){ return false; }); ");
        ...
        sb.Append("format: 'dd M',");
        //sb.Append("minDate: '01/01/" + DateTime.Now.Year.ToString() + "'");
