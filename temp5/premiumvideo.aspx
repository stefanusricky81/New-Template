<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="premiumvideo.aspx.cs" Inherits="premiumvideo" %>
            ...
            <asp:DataList ID="dlFreeVideo" runat="server" Width="100%" RepeatColumns="3">
                <ItemTemplate>
                    <div class="col-xs-6 col-sm-12 col-md-12" data-src='<%# Eval("VideoLogo") %>'>
                        <a href='Single.aspx?cat=<%# Eval("VideoId") %>' class="thumbnail">
