<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LatestWallpaper.aspx.cs" Inherits="LatestWallpaper" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">
        <div class="row tittlePage">
            <h3>WALLPAPER TERBARU</h3>
        </div>
        <div class="blurred-bg gallery">
            <asp:DataList ID="dlFreeWallPaper" runat="server" RepeatColumns="3">
                <ItemTemplate>
                    <div class="col-xs-6 col-sm-12 col-md-12">
                        <a href="singlewallpaper.aspx?cat=<%# Eval("WallPaperID") %>&msisdn=<%# Request["msisdn"] %>" class="thumbnail">
