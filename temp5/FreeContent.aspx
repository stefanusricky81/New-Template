<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FreeContent.aspx.cs" Inherits="FreeContent" %>
    ...
    <div class="container">
        ...
        <div class="blurred-bg gallery">
                ...
                <ItemTemplate>
                    <div class="col-xs-6 col-sm-12 col-md-12">
                         <%if(Request["msisdn"] != string.Empty && Request["msisdn"] != null ){ %>
                            <a href='ArtistList.aspx?cat=<%# Eval("WallPaperArtist") %>&msisdn=<%# Request["msisdn"] %>' class="thumbnail">
                        <%  } else {%>
            ...
            <p class="text-center container">
                ...
                <a href="ArtistList.aspx" class="btn btn-primary grayBg">SELEBIHNYA&nbsp; <i class="fa fa-arrow-circle-right "></i></a>
            </p>
        </div>
        <br />
        <div class="subhead">
            ...
            <asp:DataList ID="dlFreeVideo" runat="server" Width="100%" RepeatColumns="3">
                <ItemTemplate>
                    <div class="col-xs-6 col-sm-12 col-md-12" data-src='<%# Eval("VideoLogo") %>'>
                        <%if(Request["msisdn"] != string.Empty && Request["msisdn"] != null ){ %>
                            <a href='ArtistList.aspx?cat=<%# Eval("VideoArtist") %>&msisdn=<%# Request["msisdn"] %>' class="thumbnail" >
                        <%  } else {%>
                            <a href="#" class="thumbnail wrapper" data-toggle="modal" data-target=".defaultModal">
                        <%} %>
