    ...
    <div class="container">
        ...
        <div class="blurred-bg gallery">
                ...
                <ItemTemplate>
                    <div class="col-xs-6 col-sm-12 col-md-12">
                        <%if(Request["msisdn"] != string.Empty && Request["msisdn"] != null ){ %>
                            <a href='freewallpaper.aspx?cat=<%# Eval("WallPaperArtist") %>&msisdn=<%# Request["msisdn"] %>' class="thumbnail">
                        <%  } else {%>
            ...
            <p class="text-center container">
                ...
                <a href="freewallpaper.aspx" class="btn btn-primary grayBg">SELEBIHNYA&nbsp; <i class="fa fa-arrow-circle-right "></i></a>
            </p>
        </div>
        <br />
        <div class="subhead">
        ...
        <div class="gallery blurred-bg">
            ...
            <p class="text-center container">
                ...
                <a href="freevideo.aspx" class="btn btn-primary grayBg">SELEBIHNYA&nbsp; <i class="fa fa-arrow-circle-right "></i></a>
            </p>
        </div>
        <br />
