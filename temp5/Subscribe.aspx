<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Subscribe.aspx.cs" Inherits="Subscribe" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
        <div class="jumbotron blurred-bg">
            ...
            <div class="row">
                <p class="col-xs-12">
                    Anda akah membeli konten Top Model Indonesia seharga Rp.3300. Ayo! Sedikit lagi anda akan mendapatkan salah satu konten terbaik dari <strong>Top Model Indonesia!</strong>
