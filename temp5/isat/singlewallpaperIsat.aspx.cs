...
public partial class singlewallpaper : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                DataSet ds = Users.IsRegisteredIsat(msisdn);
                if (ds.Tables[0].Rows[0][0].ToString() == "0")
                    Response.Redirect("DefaultIsat.aspx?msisdn=" + Request["msisdn"]);
            }
            BindFreeWallPaper();
        }
    }
    ...
    protected void btnHome_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("DefaultIsat.aspx?msisdn=" + msisdn);
    }
    ...
    protected void Buy()
    {
        ...
        callback = "http://topmodelindo.com/isat/ThanksPageIsat.aspx";
