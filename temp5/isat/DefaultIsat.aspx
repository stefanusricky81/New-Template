<%@ Page Title="" Language="C#" MasterPageFile="~/isat/MasterPageIsat.master" AutoEventWireup="true" CodeFile="DefaultIsat.aspx.cs" Inherits="_Default" %>
    ...
    <div class="container" style="text-align: center;">
        ...
        <div class="blurred-bg gallery border0">
                ...
                <ItemTemplate>
                    <div class="col-xs-6 col-sm-12 col-md-12 col-lg-12" data-src='<%# Eval("WallPaperLogo") %>'>
                        <%if(Request["msisdn"] != string.Empty && Request["msisdn"] != null ){ %>
                            <a href='LatestWallpaperIsat.aspx?cat=<%# Eval("WallPaperArtist") %>&msisdn=<%# Request["msisdn"] %>' class="thumbnail wrapper">
                        <%  } else {%>
            ...
            <p class="text-center container">
                ...
                <a href="LatestWallpaperIsatIsat.aspx" class="btn btn-primary grayBg">SELEBIHNYA&nbsp; <i class="fa fa-arrow-circle-right "></i></a>
            </p>
        </div>
        <div class="gallery blurred-bg">
            ...
            <asp:DataList ID="dlFreeVideo" runat="server" Width="100%" RepeatColumns="3">
                <ItemTemplate>
                    <div class="col-xs-6 col-sm-12 col-md-12 col-lg-12" data-src='<%# Eval("VideoLogo") %>'>
                        <%if(Request["msisdn"] != string.Empty && Request["msisdn"] != null ){ %>
                            <a href='LatestVideoIsat.aspx?cat=<%# Eval("VideoArtist") %>&msisdn=<%# Request["msisdn"] %>' class="thumbnail wrapper">
                        <%  } else {%>
                            <a href="#" class="thumbnail wrapper" data-toggle="modal" data-target=".defaultModal">
                        <%} %>
            ...
            <p class="text-center container">
                ...
                <a href="LatestVideoIsat.aspx" class="btn btn-primary grayBg">SELEBIHNYA&nbsp; <i class="fa fa-arrow-circle-right "></i></a>
            </p>
        </div>
        ...
        <div class="blurred-bg gallery">
            <asp:DataList ID="dlPremiumVideo" runat="server" Width="100%" RepeatColumns="3">
                <ItemTemplate>
                    <div class="col-xs-6 col-sm-12 col-md-12 col-lg-12" data-src='<%# Eval("VideoLogo") %>'>
                        <a href='premiumvideoIsat.aspx?cat=<%# Eval("VideoArtist") %>&msisdn=<%# Request["msisdn"] %>'  class="thumbnail wrapper">
                            <img src='<%# Eval("VideoLogo") %>' alt='<%# Eval("VideoTitle") %>' class="img-responsive" oncontextmenu="return false" />
                            <h4 class="ModelTittle text-center"><%# Eval("VideoTitle") %></h4>
                        </a>
                    </div>
            ...
            <p class="text-center container">
                ...
                <a href="premiumvideoIsat.aspx" class="btn btn-primary grayBg">SELEBIHNYA&nbsp; <i class="fa fa-arrow-circle-right "></i></a>
            </p>
        </div>
