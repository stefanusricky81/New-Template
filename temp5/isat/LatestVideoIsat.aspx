<%@ Page Title="" Language="C#" MasterPageFile="~/isat/MasterPageIsat.master" AutoEventWireup="true" CodeFile="LatestVideoIsat.aspx.cs" Inherits="LatestVideo" %>
            ...
            <asp:DataList ID="dlFreeVideo" runat="server" Width="100%" RepeatColumns="3">
                <ItemTemplate>
                    <div class="col-xs-6 col-sm-12 col-md-12" data-src='<%# Eval("VideoLogo") %>'>
                        <a href="SinglefreeIsat.aspx?cat=<%# Eval("VideoID") %>&msisdn=<%# Request["msisdn"] %>" class="thumbnail">
