<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SubscribeAngel.aspx.cs" Inherits="SubscribeAngle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">
        <div class="jumbotron blurred-bg">
            ...
            <div class="row">
                <p class="col-xs-12">
                    Anda akan berlangganan <strong>Top Model Indonesia!</strong>, Nikmati layanan video dan wallpaper kami sepuasnya hanya dengan Rp. 3300/mgg!!!<br />
