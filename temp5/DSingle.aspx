<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DSingle.aspx.cs" Inherits="DSingle" %>
                ...
                <asp:DataList ID="dlUpnext" runat="server" Width="100%" RepeatColumns="1" RepeatLayout="Table" CellPadding="3">
                    <ItemTemplate>
                        <div class="gallery blurred-bg">
                            <div class="col-xs-6">
                                <a href='Single.aspx?cat=<%# Eval("VideoId") %>&msisdn=<%# Request["msisdn"] %>'>
                                    <img src='<%# Eval("VideoLogo") %>' class="img-responsive" /></a>
                            </div>
                            <div class="col-xs-6 SingleDsc">
                                <a href='Single.aspx?cat=<%# Eval("VideoId") %>&msisdn=<%# Request["msisdn"] %>' class="title"><%# Eval("VideoTitle") %></a>
