<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Singlefree.aspx.cs" Inherits="Singlefree" %>
                ...
                <asp:DataList ID="dlUpnext" runat="server" Width="100%" RepeatColumns="1" RepeatLayout="Table" CellPadding="3">
                    <ItemTemplate>
                        <div class="gallery blurred-bg">
                            <div class="col-xs-6">
                                <a href='Singlefree.aspx?cat=<%# Eval("VideoId") %>&msisdn=<%# Request["msisdn"] %>'>
                                    <img src='<%# Eval("VideoLogo") %>' class="img-responsive" /></a>
                            </div>
                            <div class="col-xs-6 SingleDsc">
                                <a href='Singlefree.aspx?cat=<%# Eval("VideoId") %>&msisdn=<%# Request["msisdn"] %>' class="title"><%# Eval("VideoTitle") %></a>
