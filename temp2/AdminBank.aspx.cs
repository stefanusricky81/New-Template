...
public partial class AdminBank : System.Web.UI.Page
{
    ...
    {
        if (txtBankName.Text == string.Empty) return "Bank Name Can't Empty";
    ...
    protected void loaddata()
    {
        ...
        smd = new SqlCommand("GET_DETAILBANK", conn.getconn());
        ...
        if (sdr.Read())
        {
            txtBankName.Text = sdr["BANK_NAME"].ToString();
        }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (CekValidation == string.Empty)
        {
            ...
            if (Request.Params["type"] == "edit")
            {
                smd = new SqlCommand("UPDATE_BANK", conn.getconn());
                smd.Parameters.AddWithValue("@Id", Request.Params["ID"]);
            }
            else
            {
                smd = new SqlCommand("SP_INSERTBANK", conn.getconn());
            }

            smd.Parameters.AddWithValue("@BankName", txtBankName.Text);
    ...
    protected void bDelete_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow dvr in GV.Rows)
        {
            ...
            if (cb != null && cb.Checked)
            {
                ...
                smd = new SqlCommand("DELETE_BANK", conn.getconn());
