<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AdminStock.aspx.cs" Inherits="AdminStock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
        <div>
            <center><h1 style="width:945px; color:#000000; font-size:20px; margin-bottom:10px;">Stock</h1></center>
        </div>
        <div class="sign-in">
            <table>
                <tr>
                ...
                <tr>
                    <td>Size :</td>
                    <td></td>
                    <td><asp:DropDownList ID="ddlSize" runat="server" /></td>
                </tr>
                <tr>
                    <td>Color :</td>
                    <td></td>
                    <td><asp:DropDownList ID="ddlColor" runat="server" /></td>
                </tr>
                <tr>
                    <td>Stock :</td>
                    <td></td>
                    <td><asp:TextBox ID="txtStock" runat="server" Width="240" /></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    ...
                    <td>
                        <asp:GridView ID="GV" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField DataTextField="PRODUCTNAME" HeaderText="Product Name" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="AdminStock.aspx?type=edit&ID={0}" ItemStyle-Width="150px" />
                                <asp:BoundField DataField="SIZE" HeaderText="Size" ItemStyle-Width="100px" />
