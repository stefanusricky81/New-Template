<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.master" AutoEventWireup="true" CodeFile="LssCouture.aspx.cs" Inherits="LssCulture" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="kirir" Runat="Server">
    ...
    <ul class="kiri-1">
       <li>GIRLS</li>
       <ul>
             <li><a href="LssCouture.aspx?f=GT">Tops</a></li>
             <li><a href="LssCouture.aspx?f=GB">Bottoms</a></li>
             <li><a href="LssCouture.aspx?f=GD">Dresses</a></li>
             <li><a href="LssCouture.aspx?f=GJ">Baby</a></li>
       </ul>
       <li>BOYS</li>
       <ul>
             <li><a href="LssCouture.aspx?f=BT">Tops</a></li>
             <li><a href="LssCouture.aspx?f=BB">Bottoms</a></li>
             <li><a href="LssCouture.aspx?f=BD">Dresses</a></li>
             <li><a href="LssCouture.aspx?f=BJ">Baby</a></li>
       </ul>
    </ul>
