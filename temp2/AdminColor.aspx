<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AdminColor.aspx.cs" Inherits="AdminColor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
       <div>
            <center><h1 style="width:945px; color:#000000; font-size:20px; margin-bottom:10px;">Master Color</h1></center>
        </div>
        <div class="sign-in">
            <table>
                <tr>
                    <td>Color :</td>
                    <td></td>
                    <td><asp:TextBox ID="txtColor" runat="server" Width="240" /></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    ...
                    <td>
                        <asp:GridView ID="GV" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField DataTextField="COLOR" HeaderText="Color" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="AdminColor.aspx?type=edit&ID={0}" ItemStyle-Width="50px" />
                            </Columns>
