<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AdminEkpedisi.aspx.cs" Inherits="AdminEkpedisi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
        <div>
            <center><h1 style="width:945px; color:#000000; font-size:20px; margin-bottom:10px;">Master Ekpedisi</h1></center>
        </div>
        <div class="sign-in">
            <table>
                <tr>
                    <td>Nama Ekpedisi :</td>
                    <td></td>
                    <td><asp:TextBox ID="txtName" runat="server" Width="240" /></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:GridView ID="GV" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField DataTextField="Nama_Ekspedisi" HeaderText="Nama" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="AdminEkpedisi.aspx?type=edit&ID={0}" ItemStyle-Width="50px" />
                                <asp:BoundField DataField="Price_Per_Kilo" HeaderText="Harga Per Kilo" ItemStyle-Width="100px" />
                            </Columns>
