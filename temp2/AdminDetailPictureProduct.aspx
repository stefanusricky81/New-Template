<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AdminDetailPictureProduct.aspx.cs" Inherits="AdminDetailPictureProduct" %>
                    ...
                    <td>
                        <asp:GridView ID="GV" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField DataTextField="PRODUCTNAME" HeaderText="Product Name" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="AdminDetailPictureProduct.aspx?type=edit&ID={0}" ItemStyle-Width="150px" />
                                <asp:TemplateField HeaderText="Image" SortExpression="img">
                                    <ItemTemplate>
                                        <asp:Image ID="Image1" runat="server" Width="100px" Height="100px" ImageUrl='<%# Bind("IMAGE_DETAIL")  %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
