<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.master" AutoEventWireup="true" CodeFile="Moms.aspx.cs" Inherits="Moms" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="kirir" Runat="Server">
    ...
    <ul class="kiri-1">
       <li>GIRLS</li>
       <ul>
             <li><a href="Moms.aspx?f=GT">Tops</a></li>
             <li><a href="Moms.aspx?f=GB">Bottoms</a></li>
             <li><a href="Moms.aspx?f=GD">Dresses</a></li>
             <li><a href="Moms.aspx?f=GJ">Baby</a></li>
       </ul>
       <li>BOYS</li>
       <ul>
             <li><a href="Moms.aspx?f=BT">Tops</a></li>
             <li><a href="Moms.aspx?f=BB">Bottoms</a></li>
             <li><a href="Moms.aspx?f=BD">Dresses</a></li>
             <li><a href="Moms.aspx?f=BJ">Baby</a></li>
       </ul>
    </ul>
