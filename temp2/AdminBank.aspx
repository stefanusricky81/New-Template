<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AdminBank.aspx.cs" Inherits="AdminBank" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
        <div>
            <center><h1 style="width:945px; color:#000000; font-size:20px; margin-bottom:10px;">MASTER BANK</h1></center>
        </div>
        <div class="sign-in">
            <table>
                <tr>
                    <td>Bank Name :</td>
                    <td></td>
                    <td><asp:TextBox ID="txtBankName" runat="server" Width="240" /></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                ...
                <td>
                    <asp:GridView ID="GV" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField DataTextField="BANK_NAME" HeaderText="Bank Name" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="AdminBank.aspx?type=edit&ID={0}" ItemStyle-Width="50px" />
                        </Columns>
