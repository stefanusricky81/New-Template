...
namespace cs_forest
{
    public partial class CreateUser : System.Web.UI.Page
    {
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (isNumeric)
            {
                ...
                if (Request.QueryString["type"] != "update")
                {
                    ...
                    message += "<p>Kindly use the login credential to access - http://103.253.113.205/csfin/.</p>";
        ...
        public void BindModules()
        {
            ...
            try
            {
                using (SqlConnection cn = new SqlConnection(model.ConnStr("205", "CustomerServicesIndonesia")))
                {
                    cn.Open();
