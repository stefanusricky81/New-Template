<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSMPP.Master" AutoEventWireup="true" CodeBehind="SMPPSearchMT.aspx.cs" Inherits="cs_forest.SMPPSearchMT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div style="text-align: center" runat="server" id="panel_globe">
                <div class="dashboard-form" style="margin: 0 5px 20px 5px; display: inline-block;">
                    <h3>MT</h3>
                    <span style="color: #333333; font-size: 14px">Search by </span>
                    <asp:RadioButton ID="RBMsisdn" GroupName="type" Font-Size="10" ForeColor="#333333" runat="server" Text="Msisdn" AutoPostBack="true" OnCheckedChanged="RBMsisdn_CheckedChanged"/>
                    <asp:RadioButton ID="RBMessageId" GroupName="type" Font-Size="10" ForeColor="#333333" runat="server" Text="Message Id" AutoPostBack="true" OnCheckedChanged="RBMessageId_CheckedChanged"/>
                    <div style="margin-top: 7px;">
                        <img src="images/phone-icon.png" style="vertical-align: middle; margin-right: 3px;" />
                        <asp:TextBox ID="txtGlobeMsisdn" runat="server" Width="178" MaxLength="15" CssClass="input" onkeypress="return isNumber(event)" onblur="if(this.value=='')this.value='MSISDN (e.g 60127654321)';" value="MSISDN (e.g 60127654321)" onfocus="if(this.value=='MSISDN (e.g 60127654321)')this.value='';"></asp:TextBox>
                        <asp:TextBox ID="txtGlobeMsgId" runat="server" Width="178" MaxLength="15" CssClass="input" onblur="if(this.value=='')this.value='Message Id (e.g 8hsg6ak3)';" value="Message Id (e.g 8hsg6ak3)" onfocus="if(this.value=='Message Id (e.g 8hsg6ak3)')this.value='';"></asp:TextBox>
                    </div>
                    <asp:Button ID="btnSearchMysql" runat="server" OnClick="btnSearchMysql_Click" Text="Search" CssClass="btn" />
                </div>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
