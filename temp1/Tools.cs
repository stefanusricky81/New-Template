...
namespace cs_forest
{
    public class Tools
    {
        ...
        public void SendMOGlobePH(string msisdn)
        {
            string result = string.Empty;
            string sTxID = DateTime.Now.Ticks.ToString();

            string sUrl = "http://210.5.41.104/globephmo/MO.aspx?";
            sUrl = sUrl + "SMS_Message_String=GWPH STOP";
            sUrl = sUrl + "&CSP_Txid=" + sTxID;
            sUrl = sUrl + "&SUB_Mobtel=" + msisdn;
            sUrl = sUrl + "&type=CS";
