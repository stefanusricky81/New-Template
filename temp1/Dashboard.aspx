...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div style="text-align: center" runat="server" id="panel_default">
                ...
                <div class="dashboard-form" runat="server" id="panelMT" style="margin: 0 5px 20px 5px; display: inline-block;">
                    <div>
                        ...
                        <br /><asp:Label runat="server" ID="lblMTExample" Font-Size="Smaller"></asp:Label>
                    </div>
                    <br />
                ...
                <div class="dashboard-form" runat="server" id="panelMO" style="margin: 0 5px 20px 5px; display: inline-block;">
                    <div>
                        ...
                        <br /><asp:Label runat="server" ID="lblMOExample" Font-Size="Smaller"></asp:Label>
                    </div>
                    <br />
                ...
                <div id="panel_subscriber" runat="server" class="dashboard-form" style="margin: 0 5px 20px 5px; display: inline-block; text-align: center;">
                    <div>
                        ...
                        <br /><asp:Label runat="server" ID="lblSubExample" Font-Size="Smaller"></asp:Label>
                ...
                <br />
                <div id="panel_blacklist" runat="server" class="dashboard-form" style="margin: 0 5px 20px 5px; display: inline-block;">
                    <h3>Blacklist</h3>
                    ...
                    <div style="margin-top: 15px">
                        ...
                        <br /><asp:Label runat="server" ID="lblBlackListExample" Font-Size="Smaller"></asp:Label>
                ...
                <asp:Panel runat="server" ID="BatchUploadPanel" Visible="false">
                    <div class="dashboard-form" runat="server" id="Div1" style="margin: 0 5px 20px 5px; display: inline-block; width: 650px;">
                        <div>
                            <h3>Batch Upload</h3>
                            <asp:FileUpload ID="FileUpload1" runat="server" />
                            <asp:Label runat="server" ID="Label1" Font-Size="Smaller"></asp:Label>
                            <asp:Button ID="btnBlkList" runat="server" OnClick="btnBlkList_Click" Text="Upload Black list" CssClass="btn" />
                            <br />
                            <br />
                            <asp:FileUpload ID="FileUpload2" runat="server" />
                            <asp:Label runat="server" ID="Label2" Font-Size="Smaller"></asp:Label>
                            <asp:Button ID="btnUnsubList" runat="server" OnClick="btnUnsubList_Click" Text="Upload Unsub List" CssClass="btn" />
                        </div>
            ...
            <asp:Panel runat="server" ID="pnlDescription" Visible="false">
                ...
                <ul style="text-align: center">
                    <li>MT SEARCH: Key in the country code followed by the remaining msisdn to search for the message sent  to that specific msisdn. 
                        <br />
                        <h4>Example:  63 xxxxxxxxx</h4>
                        <hr />
                    </li>
                    <li>MO SEARCH:  Key in the country code followed by the remaining msisdn to search for the message received to that specific msisdn. 
                        <br />
                        <h4>Example:  63 xxxxxxxxx</h4>
                        <hr />
                    </li>
                    <li>SEARCH SUBSCRIBER:  Key in the country code followed by the remaining msisdn to search and view whether  that specific msisdn is subscribed. “No Data to display” will prompt if msisdn is unsubscribed/not in the system. 
                        <br />
                        <h4>Example:  63 xxxxxxxxx<hr />
                        </h4>
                    </li>
                    <li>SEARCH BLACKLIST:  Key in in the country code followed by the remaining msisdn to search and view the blacklisted msisdn in the system. Blacklisted msisdn in the system shows its timestamp.
                        <br />
                        <h4>Example:  63xxxxxxxxx<hr />
                        </h4>
                    </li>
                    <li>ADD BLACKLIST:  Key in in the country code followed by the remaining msisdn to add the msisdn to the blacklisted list in the system. Blacklisted msisdn will automatically unsubscribe to the service and will no longer receive any messages nor be charged in the future by Game world. 
                        <br />
                        <h4>Example:  63 xxxxxxxxx<hr />
                        </h4>
                    </li>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="btnBlkList" />
            <asp:PostBackTrigger ControlID="btnUnsubList" />
        </Triggers>
    </asp:UpdatePanel>
