...
namespace cs_forest
{
    public partial class SMPPAddRoute : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["type"] == "update")
            {
                model.UpdateSMPPRoute(id, txtRoute.Text, DDLSystemId.SelectedValue, DDLHTTPApi.SelectedValue, txtPrefix.Text, txtOperator.Text, txtCountry.Text);
                lblMessage.Text = "Route has been successfully update.";
            }
            else
            {
                model.AddSMPPRoute(txtRoute.Text, DDLSystemId.SelectedValue, DDLHTTPApi.SelectedValue, txtPrefix.Text, txtOperator.Text, txtCountry.Text);
