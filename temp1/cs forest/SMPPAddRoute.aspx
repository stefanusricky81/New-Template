<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSMPP.Master" AutoEventWireup="true" CodeBehind="SMPPAddRoute.aspx.cs" Inherits="cs_forest.SMPPAddRoute" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="create-user-form" style="min-height:300px;width:390px;">
        ...
        <div class="field-wrapper" style="margin: 0 0 15px 0;">
            ...
            <%--<asp:DropDownList ID="DDLCountry" CssClass="input" runat="server" Style="width: 96%;">
