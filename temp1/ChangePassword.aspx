...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="create-user-form">
        ...
        <div class="field-wrapper" style="margin: 0 0 10px 0;">
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" Display="Dynamic" ForeColor="IndianRed" ErrorMessage="Invalid Password need contain capital letter, symbol, and number" Font-Size="10" ControlToValidate="txtNewPassword" ValidationExpression="^.*(?=.{8,})(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!*@#$%^&+=]).*$" Style="margin-left:28px;font-weight:600;font-size: .8125em;"></asp:RegularExpressionValidator>
