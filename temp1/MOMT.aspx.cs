...
namespace cs_forest
{
    public partial class MOMT : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            pnlExportMo.Visible = false;
            pnlMtPH.Visible = false;
            if (type == "mt")
            {
        ...
        {
            gridMTExp.WriteCsvToResponse();

        }

        protected void btnXLSX_Click(object sender, EventArgs e)
        {
            gridMTExp.WriteXlsxToResponse();

        }

        protected void btnXLS_Click(object sender, EventArgs e)
        {
            gridMTExp.WriteXlsToResponse();
