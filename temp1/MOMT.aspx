...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlMtPH" Visible="false" runat="server">
        <table class="BottomMargin">
            <tr>
                <td style="padding-right: 4px">
                    <dx:ASPxButton ID="btnXLS" runat="server" Text="Export to XLS" UseSubmitBehavior="False"
                        OnClick="btnXLS_Click" />
                </td>
                <td style="padding-right: 4px">
                    <dx:ASPxButton ID="btnXLSX" runat="server" Text="Export to XLSX" UseSubmitBehavior="False"
                        OnClick="btnXLSX_Click" />
                </td>
                <td>
                    <dx:ASPxButton ID="btnCSV" runat="server" Text="Export to CSV" UseSubmitBehavior="False"
    ...
    <dx:ASPxGridViewExporter ID="gridMTExp" runat="server" GridViewID="ASPxGridView1"></dx:ASPxGridViewExporter>


    <%-- Globe PH --%>
    <asp:Panel ID="pnlExportMo" Visible="false" runat="server">
        <table class="BottomMargin">
            <tr>
                <td style="padding-right: 4px">
